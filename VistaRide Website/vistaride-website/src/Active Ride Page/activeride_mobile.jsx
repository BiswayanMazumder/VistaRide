...
export default function Activeride_mobile() {
        ...
        <div className='webbody'>
            <div className="ejhfjhfd">
                ...
                <div className="dfnjvnvn">
                    ...
                    <div className="dbvndv" style={{marginTop:'5px'}}>
                    {rideverified?(<svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="20" height="20" viewBox="0 0 48 48">
<path fill="#c8e6c9" d="M36,42H12c-3.314,0-6-2.686-6-6V12c0-3.314,2.686-6,6-6h24c3.314,0,6,2.686,6,6v24C42,39.314,39.314,42,36,42z"></path><path fill="#4caf50" d="M34.585 14.586L21.014 28.172 15.413 22.584 12.587 25.416 21.019 33.828 37.415 17.414z"></path>
                    ...
                    <div className="dnjndjv" style={{ color: 'grey', fontWeight: '400', marginLeft: '20px', marginRight: '20px', marginTop: '20px', display: 'flex', flexDirection: 'column', width: "100vw" }}>
                        {carmodel}
                    </div>
                    <div className="dnjndjv" style={{ color: 'grey', fontWeight: '400', marginLeft: '20px', marginRight: '20px', marginTop: '20px', display: 'flex', flexDirection: 'column', width: "100vw" }}>
                        {drivername}
                    </div>
                    <div className="dnjndjv" style={{ color: 'black', marginTop: '20px', width: "100vw" }}>
                        <div>
